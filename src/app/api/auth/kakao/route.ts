...
// 참고: account_email/name(실명) 등은 비즈니스 인증 전이라 권한이 없어 요청 시 KOE205 오류가 발생하므로,
// 개인 앱에서 사용 가능한 profile_nickname(닉네임)만 scope로 요청한다.
...
export async function GET(req: NextRequest) {
  ...
  authorizeUrl.searchParams.set('scope', 'profile_nickname');
